...
along the way. If I want to call Luigi, what would we need to know? We need a number associated with
Luigi. If we had that number, we can use it to get in touch with Luigi’s phone. When we use that number,
